...
Report 51516047 P9Report
{
    ...
    dataset
    {
        dataitem("Payroll Employee.";"Payroll Employee.")
        {
            ...
            column(FirstName_HREmployees;"Payroll Employee."."First Name")
            {
            }
            column(MiddleName_HREmployees;"Payroll Employee.".Surname)
            {
            }
            column(LastName_HREmployees;"Payroll Employee."."Middle Name")
            {
            }
            column(Initials_HREmployees;"Payroll Employee."."Middle Name")
            {
            }
            ...
            {
                DataItemLink = "Employee Code"=field("No."),"Payroll Period"=field("Period Filter");
            ...
            begin
                ...
                P9.SetRange(P9."Period Year",2021);
                //P9.SETRANGE(P9."Period Year",2022);
                if P9.Find('-') then
                 begin
                  repeat
