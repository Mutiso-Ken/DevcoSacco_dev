...
//                     ObjPayrollMonthlyTransactions.SetRange(ObjPayrollMonthlyTransactions."No.", "Payroll Employee P9."."Employee Code");
...
//         CompPINNo: Code[100];
//         ObjPayrollMonthlyTransactions: Record "Payroll Monthly Transactions";
// }
