...
// Page 51516531 "FOSA Accounts Applied Card"
// {
...
//                             //SMS Notification
//                             SendSMS;
//                             Message(Format("Account Type") + ' Account for' + Format(Name) + ' created successfully. Assign No. is - %1', AcctNo);
//                             CurrPage.Close();
//                         end;
...
//         SMSMessage."SMS Message" := 'Dear Member, your ' + format("Account Type") + ' FOSA Account No. ' + AcctNo + ' has been opened successfully.' + CompInfo.Name;
