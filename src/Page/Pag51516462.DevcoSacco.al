        ...
        area(sections)
        {
            ...
            group("CEEP Management")
            {
                ...
                group("CEEP Group Management")
                {
                    ...
                    group("CEEP Group Applications")
                    {
                        ...
                        // {
                        //     Image = Group;
                        //     RunPageView = WHERE(Status = CONST(Open), "Account Category" = const(Joint));
                        //     RunObject = page "Group Application List";
                        // }
                        // action("Group Application-Pending Approval")
                        // {
                        //     Image = Group;
                        //     RunPageView = WHERE(Status = CONST(Pending), "Account Category" = const(Joint));
                        //     RunObject = page "MC Individual Application List";
                        // }
                        // action("Group Application-Pending Registration")
                        // {
                        //     Image = Group;
                        //     RunPageView = WHERE(Status = CONST(Approved), "Account Category" = const(Joint));
                        //     RunObject = page "MC Individual Application List";
                        // }
                    }
                ...
                group("CEEP Setups")
                {
                    ...
                    action("CEEP Individual List -Editable")
                    {
                        Image = Group;
                        RunObject = page "MC Group List-Editable";
                        Visible = false;
            ...
            group(CloudPesa)
            {
...

                {
                    ...
                    action("ABC ATM Transations")
                    {
                        Caption = 'ABC ATM Transations';
                        Image = Bank;
            ...
            group("System Administration")
            {
                ...
                group("FOSA Setups")
                {
                    action("Account Types Setup")
                    {
                        Caption = 'Account Types Setup';
                        Image = Receipt;
                    ...
                    action("Cheque Commission Charges")
                    {
                        Caption = 'Cheque Commission Charges Setup';
                        Image = Receipt;
                        RunObject = page "Cheque Commission List";

                    }

                    action("Tea Commission Charges")
                    {
                        Caption = 'Tea Commission Charges Setup';
                        Image = Receipt;
                        RunObject = page "Tea Commissions List";

                    }
                    action("Milk Commission Charges")
                    {
                        Caption = 'Milk Commission Charges Setup';
                        Image = Receipt;
                        // RunObject = page "ATM Log Entries";
                ...
                group("Developer Automations")
                {
                    ...
                    {
                        ApplicationArea = Basic, Suite;
                        Caption = 'Update Closed Membership Applications';
                        RunObject = report "Update Closed Member Apps";
                    }
                }
            ...
            {
                Visible = false;
                action("Run Monthly FOSA A/cs Interest")
                {
                    RunObject = codeunit "Generate Monthly FOSA Interest";
                }
                action(GenerateLoanInterestDue)
                {
                    RunObject = codeunit GenerateLoanInterestDue;
                    image = CostAccountingDimensions;
                    Caption = 'POST Monthly Loan Interests';
                    Enabled = true;
                }
                action("Charge FOSA Account Maintain")
                {
                    RunObject = codeunit "Charge FOSA Account Maintain";
                    image = CostAccountingDimensions;
                    Caption = 'Charge FOSA Account Maintain';
                    Enabled = true;
                }
                action("Update CustLedgeEntryLoanType")
                {
                    RunObject = codeunit "Update CustLedgeEntryLoanType";
                    image = CostAccountingDimensions;
                    Caption = 'Update CustLedgeEntry LoanType';
                    Enabled = true;
                }
                action("Generate Loan Performance")
                {
                    RunObject = codeunit "Generate Loan Performance";
                    image = CostAccountingDimensions;
                    Caption = 'Generate Loan Performance Classification';
                    Enabled = true;
                }
            }
