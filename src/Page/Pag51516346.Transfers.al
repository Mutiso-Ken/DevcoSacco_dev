Page 51516346 "Transfers"
{
            ...
            group(General)
            {
                ...
                field(Status; Status)
                {
                    ...
                    begin
                        ...
                        Modify;
                        if Status <> Status::Open then TransfersEditable:=false
                        else
            ...
            group(Posting)
            {
                ...
                action(Post)
                {
                    ...
                    begin
                        ...
                        if Posted = true then Error('This Schedule is already posted');
    ...
    begin
        ...
        if BSched.Find('-')then begin
            repeat if BSched."Line Description" = '' then begin
