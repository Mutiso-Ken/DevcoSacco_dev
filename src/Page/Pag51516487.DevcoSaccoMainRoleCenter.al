Page 51516487 "Devco Sacco Main Role Center"
{
    Caption = 'Devco SACCO';
    PageType = RoleCenter;
        ...
        area(sections)
        {
            ...
            group("System Administration")
            {
                group("Address setup")
                {
                    ...
                    // action("Teller Transaction Types")
                    // {
                    //     RunObject = page "Teller Transaction Types";
                    // }
