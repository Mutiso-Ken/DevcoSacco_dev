                ...
                action("Recover BOSA Entrance Fee")
                {
                    ...
                    begin
                        ...
                        if Cust.FindFirst then begin
                            ...
                            if RegFee < 500 then begin
                                if Confirm('Are You sure you want to recover BOSA Entrance Fee?', false) = true then begin
                                    LineNo := LineNo + 10000;
                                    GenJournalLine.Init;
                                    GenJournalLine."Line No." := LineNo;
                                    GenJournalLine."Journal Template Name" := 'GENERAL';
                                    ...
                                    LineNo := LineNo + 10000;
                                    SFactory.FnCreateGnlJournalLineBalanced(BATCH_TEMPLATE, BATCH_NAME, DOCUMENT_NO, LineNo, GenJournalLine."transaction type"::"0", GenJournalLine."account type"::Vendor,
                                    "No.", Today, 50, 'FOSA', '', 'Charge on Entrance recovery', '', GenJournalLine."bal. account type"::"G/L Account", '5421');
